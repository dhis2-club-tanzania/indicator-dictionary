...
import CalculationDetailRow from "../../../Module/Indicator/Components/calculationDetails/Components/Row";
...
export default  function Row(props){
    ...
    function theRow(datEle){
        ...
        return <>
                ...
                <DataTableCell bordered>
                   <ol>
                       {typeof data !=='undefined'? data.categoryCombo.categories.map((cat)=>{return <li key={cat.id}>{cat.displayName}</li>}):null}
                   </ol>
                </DataTableCell>
                <DataTableCell bordered>
                    <ol>
                ...
                <DataTableCell bordered>
                    <ol>
                        {typeof data !=='undefined'?  data.dataElementGroups.map((group)=>{return <li key={group.id}>{group.displayName}</li>}):null}
                    </ol>
                </DataTableCell>
